...
class CallerArgumentExpressionAttributeDiagnosticsClient
{
	...
	try
        ...
        // Dynamic Binding
        dynamic runTime = new Beeper();
	// Delegate `System.Action' does not take arguments
        Action actn = runTime.ActionBeeper();
	try
        {
	    Invoker(actn);
        }
...
3. Interpolated string handlers
        ...
        Appended
        Format: {29-11-2021 07:18:12} is of type System.DateTime
        Formatted
        Append: {. Prohibit from proceeding}
        Appended
Stop. CurrentTime: 29-11-2021 07:18:12. Prohibit from proceeding
