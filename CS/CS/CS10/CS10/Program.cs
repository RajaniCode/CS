...
// 10. Improved definite assignment // WIP
...
// 12. Allow AsyncMethodBuilder attribute on methods // WIP
...
$ dotnet run
C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\partial-class.g.cs(1,13): warning CS0219: The variable 'b' is assigned but its value is never used [C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\CS10.csproj]
Environment.Version: 6.0.0
RuntimeInformation.FrameworkDescription: .NET 6.0.0-rtm.21522.10
...
3. Interpolated string handlers
        ...
        Appended
        Format: {29-11-2021 19:07:23} is of type System.DateTime
        Formatted
        Append: {. Prohibit from proceeding}
        Appended
Stop. CurrentTime: 29-11-2021 19:07:23. Prohibit from proceeding
...
System.ArgumentException: Argument failed validation: <This argument is passed to condition from Invoke> (Parameter 'act')
   at CallerArgumentExpressionAttributeDiagnostics.Verify(String name, Boolean flag, String text) in C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\Program.cs:line 763
   at CallerArgumentExpressionAttributeDiagnosticsClient.Invoker(Action act) in C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\Program.cs:line 831
   at CallerArgumentExpressionAttributeDiagnosticsClient.Print() in C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\Program.cs:line 846
System.ArgumentException: Argument failed validation: <This argument is passed to condition from Invoke> (Parameter 'act')
   at CallerArgumentExpressionAttributeDiagnostics.Verify(String name, Boolean flag, String text) in C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\Program.cs:line 763
   at CallerArgumentExpressionAttributeDiagnosticsClient.Invoker(Action act) in C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\Program.cs:line 831
   at CallerArgumentExpressionAttributeDiagnosticsClient.Print() in C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\Program.cs:line 859
System.ArgumentException: Argument failed validation: <This argument is passed to condition from Invoke> (Parameter 'act')
   at CallerArgumentExpressionAttributeDiagnostics.Verify(String name, Boolean flag, String text) in C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\Program.cs:line 763
   at CallerArgumentExpressionAttributeDiagnosticsClient.Invoker(Action act) in C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\Program.cs:line 831
   at CallerArgumentExpressionAttributeDiagnosticsClient.Print() in C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\Program.cs:line 871
System.ArgumentException: Argument failed validation: <This argument is passed to condition from Invoke> (Parameter 'act')
   at CallerArgumentExpressionAttributeDiagnostics.Verify(String name, Boolean flag, String text) in C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\Program.cs:line 763
   at CallerArgumentExpressionAttributeDiagnosticsClient.Invoker(Action act) in C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\Program.cs:line 831
   at CallerArgumentExpressionAttributeDiagnosticsClient.Print() in C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\Program.cs:line 884
System.ArgumentException: Expression doesn't have enough elements: This argument is passed to condition from Set (Parameter 'enumerable')
   at Extension.Set[T](IEnumerable`1 enumerable, Int32 occurrence, String text)+MoveNext() in C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\Program.cs:line 775
   at System.Collections.Generic.List`1..ctor(IEnumerable`1 collection)
   at System.Linq.Enumerable.ToList[TSource](IEnumerable`1 source)
   at CallerArgumentExpressionAttributeDiagnosticsClient.Print() in C:\Users\Rajani\Downloads\CS.NET\CS\CS10\CS10\Program.cs:line 897
